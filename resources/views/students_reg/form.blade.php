...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input class="form-control {{ $errors->has('whatsapp_number') ? 'is-invalid' : '' }}" name="whatsapp_number" id="whatsapp_number" type="text" value="{{ old('whatsapp_number', optional($user)->whatsapp_number) }}" minlength="1" maxlength="255" required="true" placeholder="Enter Whatsapp number without ISD code">
