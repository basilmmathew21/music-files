                            ...
                            <tr>
                                <td align="left" valign="top" style="padding: 0 10px;">
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                        <tbody>
                                            <tr>
                                                <td class="pc-sm-p-20 pc-xs-p-10" bgcolor="#1B1B1B" valign="top" style="padding: 10px 20px; background-color: #fff; border-radius: 8px;">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="top" style="padding: 10px;">
                                                                    <a href="{{url('/')}}" style="text-decoration: none;"><img src="{{ url('/').'vendor/adminlte/dist/img/LaravelLogo.png' }}" width="50px" height="" alt="" style="height: auto; max-width: 100%; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; color: #ffffff; font-size: 14px;"></a>
                                                                </td>
                                                            </tr>
